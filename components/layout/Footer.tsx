    ...
    <footer className="relative bg-card px-6 py-12">
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 md:flex-row md:justify-between">
        ...
        <div className="flex gap-4">
          {socialLinks.map((social) => (
            <a
              ...
              className="rounded-full border border-border p-2.5 text-text-secondary transition-all duration-300 hover:border-accent hover:text-accent hover:bg-accent/10 hover:scale-110"
              data-cursor-hover
            >
              <social.icon />
            </a>
        ...
        <p className="text-sm text-text-muted">
          &copy; {new Date().getFullYear()} Ahmed Yousif. {t("rights")}
        </p>
      </div>
    </footer>
  );
